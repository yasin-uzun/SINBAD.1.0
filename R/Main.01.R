...
process_sample_wrapper <- function(raw_fastq_dir, demux_index_file, working_dir, sample_name) 
{
	...
	sinbad_object_file = paste0(working_dir, sample_name, '/objects/sinbad_object.03.rds')
	...
	sinbad_object_file = paste0(working_dir, sample_name, '/objects/sinbad_object.05.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)

	#sinbad_object_001 = sinbad_object
	...
	sinbad_object_file = paste0(working_dir,sample_name, '/objects/sinbad_object.06.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(sinbad_object)
	...
	sinbad_object_file = paste0(working_dir, sample_name, '/objects/sinbad_object.07.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(sinbad_object)
	...
	sinbad_object_file = paste0(working_dir, sample_name, '/objects/sinbad_object.08.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(sinbad_object)
	...
	sinbad_object_file = paste0(working_dir,sample_name, '/objects/sinbad_object.09.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(sinbad_object)
	...
	sinbad_object_file = paste0(working_dir,sample_name, '/objects/sinbad_object.10.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(head(sinbad_object$df_alignment_stats))
	...
	sinbad_object_file = paste0(working_dir,sample_name, '/objects/sinbad_object.13.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	...
	sinbad_object_file = paste0(working_dir,sample_name, '/objects/sinbad_object.14.rds')
	saveRDS(sinbad_object,   file = sinbad_object_file)
	sinbad_object = readRDS(sinbad_object_file)
	print(sinbad_object)
